package cn.yiyang.cp.controller;
...
import cn.yiyang.cp.config.WxCpConfiguration;
...
public class WxPortalController {
  ...
  public ResultBean getUrl() {
    WxCpService wxCpService = WxCpConfiguration.getCpService(1000022);
    String url = wxCpService.getOauth2Service().buildAuthorizationUrl("https://www.buchang.com/ZhengheWeb/", null, WxConsts.OAuth2Scope.SNSAPI_USERINFO);
